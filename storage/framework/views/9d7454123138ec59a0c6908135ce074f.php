  ...
  <div class="container pt-4 bg-white">
    <div class="row">
      <div class="col-md-8 col-xl-6">
        <h1>Tambah Dosen</h1>
        <hr>
        <form action="<?php echo e(route('dosens.store')); ?>" method="POST">
          <?php echo csrf_field(); ?>
          ...
          <div class="form-group mb-2">
            ...
            <div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="jenis_kelamin" id="laki_laki" value="L" <?php echo e(old('jenis_kelamin')=='L' ? 'checked': ''); ?>>
                <label class="form-check-label" for="laki_laki">Laki-laki</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="jenis_kelamin" id="perempuan" value="P" <?php echo e(old('jenis_kelamin')=='P' ? 'checked': ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="telepon" name="telepon" value="<?php echo e(old('telepon')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="jurusan" id="jurusan">
              ...
              <option value="Teknik Telekomunikasi" <?php echo e(old('jurusan')=='Teknik Telekomunikasi' ? 'selected': ''); ?>>Teknik Telekomunikasi</option>
            </select>
...
unset($__errorArgs, $__bag); ?>" id="jabatan" name="jabatan" value="<?php echo e(old('jabatan')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="pendidikan" name="pendidikan" value="<?php echo e(old('pendidikan')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="alamat" rows="3" name="alamat"><?php echo e(old('alamat')); ?></textarea>
...
</html><?php /**PATH C:\laragon\www\Assesment2\resources\views/dosen/create.blade.php ENDPATH**/ ?>